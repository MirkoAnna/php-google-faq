...
$faqs = [
    ...
    [
        'title' => 'Come state implementando la recente decisione della Corte di giustizia dell\'Unione europea (CGUE) relativa al diritto all\'oblio?<br></br>',
        'text' => 
    ...
    [
        'title' => 'Come fa Google a proteggere la mia privacy e a tenere le mie informazioni al sicuro?<br></br>',
        'text' => 
                    ...
                    <a href="#">Scopri</a> quali misure adottiamo per garantire protezione e sicurezza alle tue informazioni personali, lasciando a te il controllo.<br></br><br></br>'
    ],

    [
        'title' => 'Perché il mio account è associato a un paese?<br></br>',
        'text' => 
                    ...
                    <ol type="a"><li>Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell\'Unione europea, oltre a Islanda, Liechtenstein e Norvegia) o in Svizzera.</li><br></br>
                    <li>Google LLC, con sede negli Stati Uniti, per il resto del mondo.</li></li></ol></br>
        ...
        <header>
            <div class="header">
                <div class="header-top">
                    <img class="logo" src="https://loghi-famosi.com/wp-content/uploads/2020/09/Google-Logo.png" alt="logo">
